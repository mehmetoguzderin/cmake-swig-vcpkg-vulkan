...
int create_graphics_pipeline(Init &init, RenderData &data) {
  auto vert_code = compile_file("main.vert", shaderc_glsl_vertex_shader);
  auto frag_code = compile_file("main.frag", shaderc_glsl_fragment_shader);
...
int main(int argc, char *argv[]) {
  std::cout << "Result from Lib: " << add(5, 3) << std::endl;
